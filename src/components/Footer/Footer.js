...
import IconKakao from "../../assets/ic-footer-kakao.png";
        ...
        <div className="icons">
          <a href="//launchrs.io/">
            <img
              src={luanchersheader}
              alt="launchers"
              className="logo-header-launchers"
            />
          ...
          <span>
            ...
            <div className="contact_kakao">
              <img
                ...
                alt="go to launchers kakao"
              />
              <a href="http://pf.kakao.com/_xbuybT/chat">카카오톡 문의하기</a>
            </div>
          </span>

          <div className="Footer-menu-item">
            <Link to="/youtube" className="Footer-menu-icon">
              <img
                src={IconYoutube}
                className="Footer-menu-icon"
                alt="go to launchers youtube"
              />
            </Link>
            <a
              href="//www.facebook.com/rydeapp.io/"
              className="Footer-menu-icon"
            >
              <img src={IconFacebook} alt="go to launchers facebook" />
            </a>
            <a
              href="//github.com/orgs/Launchers-lab/teams/"
              className="Footer-menu-icon"
            >
              <img
                src={IconGithub}
                className="Footer-menu-icon"
                alt="go to launchers github"
              />
            </a>
            <a
              href="//www.instagram.com/rydeapp.io"
              className="Footer-menu-icon"
            >
              <img
                src={IconInstagram}
                className="Footer-menu-icon"
                alt="go to launchers instagram"
              />
            </a>
            <Link to="/medium" className="Footer-menu-icon">
              <img
                src={IconMedium}
                className="Footer-menu-icon"
                alt="go to launchers medium"
              />
            </Link>
          </div>
        </div>
